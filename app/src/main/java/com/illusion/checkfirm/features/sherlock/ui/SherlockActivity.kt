...
class SherlockActivity : CheckFirmActivity<ActivitySherlockBinding>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sherlockViewModel.initialize(intent.getIntExtra("index", 0))
                ...
                sherlockViewModel.sherlockStatus.collect { status ->
                    when (status) {
                        SherlockStatus.INITIAL -> {
                            val animatedVector = ContextCompat.getDrawable(this@SherlockActivity, R.drawable.ic_sherlock_normal_face) as AnimatedVectorDrawable
                        ...
                        SherlockStatus.FAIL -> {
                            ...
                            val animatedVector = ContextCompat.getDrawable(this@SherlockActivity, R.drawable.ic_sherlock_fail_face) as AnimatedVectorDrawable
                            binding.statusImage.setImageDrawable(animatedVector)
                            animatedVector.start()
                        ...
                        SherlockStatus.RUNNING -> {
                            ...
                            val animatedVector = ContextCompat.getDrawable(this@SherlockActivity, R.drawable.ic_sherlock_loading_face) as AnimatedVectorDrawable
                            binding.statusImage.setImageDrawable(animatedVector)
                            animatedVector.start()
                        ...
                        SherlockStatus.SUCCESS -> {
                            binding.tabManual.isEnabled = true
                            binding.tabScript.isEnabled = true
                            val animatedVector = ContextCompat.getDrawable(this@SherlockActivity, R.drawable.ic_sherlock_success_face) as AnimatedVectorDrawable
                            binding.statusImage.setImageDrawable(animatedVector)
                            animatedVector.start()
                        ...
                        SherlockStatus.WARNING_SCRIPT_START_INVALID -> {
                            val animatedVector = ContextCompat.getDrawable(this@SherlockActivity, R.drawable.ic_sherlock_warning_face) as AnimatedVectorDrawable
                            binding.statusImage.setImageDrawable(animatedVector)
                            animatedVector.start()
