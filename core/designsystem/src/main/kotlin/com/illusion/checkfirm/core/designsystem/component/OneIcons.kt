    ...
    val OneuiSettings: ImageVector
        get() = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(13.4132f, 3.7501f)
                curveTo(13.6882f, 3.7501f, 13.9692f, 3.9681f, 14.0382f, 4.2341f)
                lineTo(14.0382f, 4.2341f)
                lineTo(14.5052f, 6.0531f)
                curveTo(14.5742f, 6.3191f, 15.1152f, 6.7891f, 15.2892f, 6.9001f)
                curveTo(15.4632f, 7.0121f, 15.8222f, 7.0431f, 16.0872f, 6.9701f)
                lineTo(16.0872f, 6.9701f)
                lineTo(17.8882f, 6.4681f)
                curveTo(18.1532f, 6.3941f, 18.4822f, 6.5281f, 18.6192f, 6.7671f)
                lineTo(18.6192f, 6.7671f)
                lineTo(20.0802f, 9.3071f)
                curveTo(20.2172f, 9.5461f, 20.1682f, 9.8991f, 19.9732f, 10.0921f)
                lineTo(19.9732f, 10.0921f)
                lineTo(18.6382f, 11.4081f)
                curveTo(18.4422f, 11.6011f, 18.2942f, 11.9281f, 18.3092f, 12.1341f)
                lineTo(18.3092f, 12.1341f)
                lineTo(18.3092f, 12.5141f)
                curveTo(18.2942f, 12.7201f, 18.4422f, 13.0481f, 18.6382f, 13.2411f)
                lineTo(18.6382f, 13.2411f)
                lineTo(19.9732f, 14.5561f)
                curveTo(20.1682f, 14.7501f, 20.2172f, 15.1031f, 20.0802f, 15.3411f)
                lineTo(20.0802f, 15.3411f)
                lineTo(18.6192f, 17.8811f)
                curveTo(18.4822f, 18.1191f, 18.1532f, 18.2541f, 17.8882f, 18.1801f)
                lineTo(17.8882f, 18.1801f)
                lineTo(16.0872f, 17.6781f)
                curveTo(15.8222f, 17.6041f, 15.1482f, 17.8391f, 14.9642f, 17.9351f)
                curveTo(14.7812f, 18.0321f, 14.5742f, 18.3281f, 14.5062f, 18.5951f)
                lineTo(14.5062f, 18.5951f)
                lineTo(14.0382f, 20.4141f)
                curveTo(13.9692f, 20.6801f, 13.6882f, 20.8981f, 13.4132f, 20.8981f)
                lineTo(13.4132f, 20.8981f)
                lineTo(10.4952f, 20.8981f)
                curveTo(10.2202f, 20.8981f, 9.9392f, 20.6801f, 9.8712f, 20.4141f)
                lineTo(9.8712f, 20.4141f)
                lineTo(9.4022f, 18.5951f)
                curveTo(9.3332f, 18.3281f, 8.7922f, 17.8591f, 8.6182f, 17.7471f)
                curveTo(8.4442f, 17.6361f, 8.0852f, 17.6041f, 7.8202f, 17.6781f)
                lineTo(7.8202f, 17.6781f)
                lineTo(6.0202f, 18.1801f)
                curveTo(5.7552f, 18.2541f, 5.4262f, 18.1191f, 5.2892f, 17.8811f)
                lineTo(5.2892f, 17.8811f)
                lineTo(3.8292f, 15.3411f)
                curveTo(3.6912f, 15.1031f, 3.7392f, 14.7501f, 3.9352f, 14.5561f)
                lineTo(3.9352f, 14.5561f)
                lineTo(5.2692f, 13.2411f)
                curveTo(5.4652f, 13.0481f, 5.6132f, 12.7201f, 5.5992f, 12.5141f)
                lineTo(5.5992f, 12.5141f)
                lineTo(5.5992f, 12.1341f)
                curveTo(5.6132f, 11.9281f, 5.4652f, 11.6001f, 5.2692f, 11.4071f)
                lineTo(5.2692f, 11.4071f)
                lineTo(3.9342f, 10.0921f)
                curveTo(3.7392f, 9.8991f, 3.6912f, 9.5461f, 3.8282f, 9.3071f)
                lineTo(3.8282f, 9.3071f)
                lineTo(5.2892f, 6.7671f)
                curveTo(5.4262f, 6.5281f, 5.7552f, 6.3941f, 6.0202f, 6.4681f)
                lineTo(6.0202f, 6.4681f)
                lineTo(7.8202f, 6.9701f)
                curveTo(8.0852f, 7.0431f, 8.7592f, 6.8081f, 8.9432f, 6.7121f)
                curveTo(9.1272f, 6.6161f, 9.3332f, 6.3191f, 9.4022f, 6.0531f)
                lineTo(9.4022f, 6.0531f)
                lineTo(9.8702f, 4.2341f)
                curveTo(9.9382f, 3.9681f, 10.2202f, 3.7501f, 10.4952f, 3.7501f)
                lineTo(10.4952f, 3.7501f)
                close()
                moveTo(11.9537f, 9.5901f)
                curveTo(10.4447f, 9.5901f, 9.2207f, 10.8141f, 9.2207f, 12.3241f)
                curveTo(9.2207f, 13.8331f, 10.4447f, 15.0581f, 11.9537f, 15.0581f)
                curveTo(13.4637f, 15.0581f, 14.6877f, 13.8331f, 14.6877f, 12.3241f)
                curveTo(14.6877f, 10.8141f, 13.4637f, 9.5901f, 11.9537f, 9.5901f)
                close()
            }
        }.build()
